...
* History (pre internet)
    * [SCiZE's CLASSIC WAREZ COLLECTION](https://scenelist.org/#)
        * BBS archive of SCENE and WAREZ
    * ANSI art and webcomic (pre internet) https://breakintochat.com/blog/2025/12/31/ansi-art-and-webcomics-part-3-eerie-and-inspector-dangerfuck/
...
### Format spec
* [MOD (file_format)](https://en.wikipedia.org/wiki/MOD_(file_format))
...
* See [[typography]]
    * (in progress: masking example snippets for democoding in TeachProgramming)
...
* [Byproduct - Music from Demoparties 2023](https://byproductmusic.com/music/mixtape/Music_from_demoparties_2023/Byproduct_-_Music_from_demoparties_2023.txt) Mixtape
