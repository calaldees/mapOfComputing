...
* [JavaScript engines zoo](https://zoo.js.org/)
    * comparison of js implementations


* [The Hacker Folk Art of Esoteric Coding](https://thereader.mitpress.mit.edu/the-hacker-folk-art-of-esoteric-coding/) - Esolangs, or esoteric programming languages, highlight the hidden metaphors and conventions that structure mainstream programming.
    * article about loads of little home grown languages
