...
* [[ai-training]]
* [[llm]]
* Coding Train [Beginner's Guide to Machine Learning in JavaScript with ml5.js](https://www.youtube.com/watch?v=26uABexmOX4&list=PLRqwX-V7Uu6YPSwT06y_AEYTqIwbeam3y&index=1) Youtube Playlist

* [AlphaDev](https://www.deepmind.com/blog/alphadev-discovers-faster-sorting-algorithms)
...
* [The Little Book of Deep Learning](https://fleuret.org/public/lbdl.pdf) François Fleure (2023?) pdf free
* [type.ai](https://type.ai/) - [Launch HN: Type (YC W23) – AI-powered document editor](https://news.ycombinator.com/item?id=35442103)
    * > We're building an AI-first document editor that helps you write.

* [Understanding Large Language Models](https://magazine.sebastianraschka.com/p/understanding-large-language-models) 2023
    * A Cross-Section of the Most Relevant Literature To Get Up to Speed
* [Understanding ChatGPT](https://www.atmosera.com/ai/understanding-chatgpt/) - top level diagrams and understanding
* [ChatGPT + Code Interpreter = Magic](https://andrewmayneblog.wordpress.com/2023/03/23/chatgpt-code-interpreter-magic/) - using ChatGPT for foundations of games
...
* [not by AI](https://notbyai.fyi/)
    * A sematic way to identify content that is generated by humans
...
* [Powerful ‘Machine Scientists’ Distill the Laws of Physics From Raw Data](https://www.quantamagazine.org/machine-scientists-distill-the-laws-of-physics-from-raw-data-20220510/)
    * [[data]]
* [🦾 codex_py2cpp 🤖 ](https://github.com/alxschwrz/codex_py2cpp) - OpenAI conversion from [[python]] to [[c]]++

* [Experiment 1: Creating a landing page using AI tools + No code](https://www.samdickie.me/writing/experiment-1-creating-a-landing-page-using-ai-tools-no-code)
* [Word-As-Image for Semantic Typography](https://wordasimage.github.io/Word-As-Image-Page/) [[typography]]
...
* [GPT makes learning fun again](https://www.vipshek.com/blog/gpt-learning) 2023
    * > Recently, I tried learning about a new subject using two approaches: 1. Google searching, 2. talking to GPT about it. I found, for the eighth time this month, that talking to GPT was far better than searching. 
      > The contrast was so striking that I thought it's worth dissecting the differences to see why the GPT experience was so much better.
...
* [Blotter: LIVE](https://www.twitch.tv/blotterstream)
    * > Blotter combines generative AI with song recognition technology to churn out audio-reactive visuals 24/7, all in real time. All songs licensed via Soundstripe. 

* [I’m an ER doctor. Here’s how I’m already using ChatGPT to help treat patients.](https://inflecthealth.medium.com/im-an-er-doctor-here-s-how-i-m-already-using-chatgpt-to-help-treat-patients-a023615c65b6)
...
[agi]: agi.md "AGI Artificial General Intelligence"
