...
* [Incremental](https://github.com/janestreet/incremental/blob/master/doc/part1-preliminaries.mdx)
    * Concepts used in functional programming with a library called _Incremental_ with examples of binding a mapping
